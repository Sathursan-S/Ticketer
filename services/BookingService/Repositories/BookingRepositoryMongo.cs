...
public class BookingRepositoryMongo : IBookingRepository
{
    ...
    private readonly ILogger<BookingRepositoryMongo> _logger;

    public BookingRepositoryMongo(IOptions<MongoDbSettings> settings, ILogger<BookingRepositoryMongo> logger)
    {
