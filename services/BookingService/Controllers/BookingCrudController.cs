...
public class BookingCrudController : ControllerBase
{
    ...
    private readonly ILogger<BookingCrudController> _logger;

    public BookingCrudController(IBookingService bookingService, ILogger<BookingCrudController> logger)
    {
