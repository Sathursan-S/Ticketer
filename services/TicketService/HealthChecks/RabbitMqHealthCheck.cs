...
namespace TicketService.HealthChecks;
...
public class RabbitMqHealthCheck : IHealthCheck
{
    ...
    public async Task<HealthCheckResult> CheckHealthAsync(HealthCheckContext context, CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            // Convert ValueTask to Task to avoid multiple await issues
            Task connectionTask = tcpClient.ConnectAsync(_host, _port, cancellationToken).AsTask();
